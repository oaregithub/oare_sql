DROP PROCEDURE text_epigraphy_iterate_char_on_tablet;
DELIMITER //
CREATE PROCEDURE `text_epigraphy_iterate_char_on_tablet`(IN this_text_uuid CHAR(36), IN this_char_on_tablet INT(4))
BEGIN
