CREATE PROCEDURE `iterate_obj_in_text_exclusive_insert`(IN this_uuid CHAR(36))
	BEGIN
		...
		UPDATE text_discourse SET obj_in_text = (obj_in_text+1) WHERE text_uuid = CONVERT(this_text_uuid USING latin1) COLLATE latin1_swedish_ci AND obj_in_text >= (this_obj_in_text+1) AND uuid != CONVERT(this_uuid USING latin1) COLLATE latin1_swedish_ci ORDER BY obj_in_text ASC;
    END