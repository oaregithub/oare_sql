CREATE PROCEDURE `add_word`(word VARCHAR (250), word_type VARCHAR (250), this_string VARCHAR (250), form VARCHAR (250), spelling VARCHAR (250), pos VARCHAR (250), that_string VARCHAR (250))
BEGIN
